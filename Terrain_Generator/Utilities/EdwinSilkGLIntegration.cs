...
namespace Egui.Silk.NET;

/// <summary>
/// Handles user input and rendering for <c>Egui</c> atop an OpenGL window.
/// </summary>
public unsafe class EdwinSilkGlIntegration : EdwinSilkIntegration
{
    /// <summary>
    ...
    /// <inheritdoc cref="EdwinSilkIntegration(Egui.Context,Silk.NET.Windowing.IWindow)"/>
    public EdwinSilkGlIntegration(Context context, IWindow window, IInputContext inputContext) : base(context, window, inputContext)
    {
        _disposed = false;
